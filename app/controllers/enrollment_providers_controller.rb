  ...
  def show
	...
	def enrollment_provider_params
      ...
      details_attributes: [:id, :start_date, :due_date,
                           ...
                           :provider_id, :group_id, :upload_payor_file, :processing_date, :terminated_date, :payor_email, :payor_phone, :payor_username, :payor_password, :_destroy, {upload_payor_file: []}, questions_attributes: [:id, :question, :answer, :_destroy] ],
