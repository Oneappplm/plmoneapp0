			...
			params.require(:enrollment_group).permit(
			   ...
			   :provider_type,
				 ...
				 :individual_ownership,
					...
					:group_liability_carrier_name,
					:group_liability_self_insured,
					:group_liability_address,
					:group_liability_city,
					:group_liability_state_id,
					:group_liability_zipcode,
					:group_liability_orig_effective_date,
					:group_liability_effective_date,
					:group_liability_expiration_date,
					:group_liability_coverage_type,
					:group_liability_unlimited_coverage,
					:group_liability_tail_coverage,
					:group_liability_coverage_amount,
					:group_liability_coverage_amount_aggregate,
					:group_liability_policy_number,
