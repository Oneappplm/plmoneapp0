  ...
  def set_overview_details
	...
	def provider_params
			params.require(:provider).permit(
					...
					:disclosure_question1,
					:disclosure_question2,
					:disclosure_question3,
					:disclosure_question4,
					:disclosure_question5,
					:disclosure_question6,
					:disclosure_question7,
					:disclosure_question8,
					:disclosure_question9,
					:disclosure_question10,
					:disclosure_question11,
					:disclosure_question12,
					:disclosure_question13,
					:disclosure_question14,
					:disclosure_question15,
					:disclosure_question16,
					:disclosure_question17,
					:disclosure_question18,
					:disclosure_question19,
					:disclosure_question20,
					:disclosure_question21,
					:disclosure_question22,
					:disclosure_question23,
					:disclosure_question24,
					:disclosure_question25,
					:disclosure_question26,
