  ...
  def set_overview_details
	...
	def provider_params
			params.require(:provider).permit(
					...
					np_licenses_attributes: [:id, :np_license_number, :np_license_effective_date, :np_license_expiration_date, :np_license_renewal_effective_date, :_destroy],
					rn_licenses_attributes: [:id, :rn_license_number, :rn_license_effective_date, :rn_license_expiration_date, :rn_license_renewal_effective_date, :_destroy],
          ...
          pa_licenses_attributes: [:id, :pa_license_number, :pa_license_effective_date, :pa_license_expiration_date, :pa_license_renewal_effective_date, :_destroy],
          dea_licenses_attributes: [:id, :dea_license_number, :dea_license_effective_date, :dea_license_expiration_date, :dea_license_renewal_effective_date, :state_id, :_destroy],
          ...
          cnp_licenses_attributes: [:id, :cnp_license_number, :effective_date, :expiration_date, :cnp_license_renewal_effective_date, :_destroy],
