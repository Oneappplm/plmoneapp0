class Mhc::ProviderEducationsController < ApplicationController
  ...
  def practice_information_params
    params.require(:provider_education).permit(
      ...
      :address, :address2, :city, :province, :state, :postal_code, :start_date, :end_date, :affiliated_university_name,
      :hospital_department_name, :training_area, :email_address, :certificate_issued_by, :program_title,
      :apa_approved_flag, :program_completed_flag, :program_director, :completion_date, :certificate_awarded,
      :teaching_position, :current_program_director, :incomplete_explanation, :phone_number, :fax_number,
      :disciplinary_action_flag, :disciplinary_action_explanation, :program_director_degree, :program_type,
      :additional_training_description, :education_type_name, :hours, :country_country_name,
      :degree_degree_abbreviation, :specialty_specialty_name, :institution_type_institution_type_description
    )
  end
end
