...
class Webscraper::SamOldService < WebscraperService
	...
	def crawl_old!
		...
		button.click
<a class="v9bk" href="SAM%2Easp" onmouseout="MM_showHideLayers('LayerSAM','','hide')" onmouseover="MM_showHideLayers('LayerSAM','','show')"><font color="black"> SAM</font></a>
