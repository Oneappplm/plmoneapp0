class PracticeOtherTaxId < ApplicationRecord
  self.primary_key = [:provider_attest_id,:provider_practice_other_tax_id,:provider_practice_other_id,:provider_practice_id]
  ...
  belongs_to :practice_other_question, foreign_key: [:provider_attest_id,:provider_practice_other_id,:provider_practice_id]
