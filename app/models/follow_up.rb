class FollowUp < ApplicationRecord
  ...
  belongs_to :enrollment_providers_detail, optional: true
  belongs_to :user
  ...
  validate :next_follow_up_date_cannot_be_in_the_past, unless: :resolution_requested?

  private

  def next_follow_up_date_cannot_be_in_the_past
    return if next_follow_up_date.blank?
    errors.add(:next_follow_up_date, "cannot be in the past") if next_follow_up_date < Date.current
  end
end
