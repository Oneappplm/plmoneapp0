class Provider < ApplicationRecord
  ...
  has_one :peer_review, dependent: :destroy
  ...
  has_many :provider_enrollment_groups, dependent: :destroy
  accepts_nested_attributes_for :provider_enrollment_groups, allow_destroy: true
