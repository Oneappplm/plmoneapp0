module Api
  module V1
    module Entities
      class EpdLogEntity < Grape::Entity
        expose :id, documentation: { type: 'Integer', desc: 'Unique ID of the EPD log entry.' }
        expose :enrollment_provider_id, documentation: { type: 'Integer', desc: 'Associated EnrollmentProvider ID.' }
