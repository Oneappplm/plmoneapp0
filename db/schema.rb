...
ActiveRecord::Schema[7.0].define(version: 2026_01_05_125332) do
  ...
  create_table "dea_master_records", force: :cascade do |t|
    t.string "dea_number"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dea_number"], name: "index_dea_master_records_on_dea_number"
    t.index ["name"], name: "index_dea_master_records_on_name"
  end
  ...
  create_table "enrollment_providers_details", force: :cascade do |t|
    ...
    t.string "tax_id"
    t.string "location"
    t.date "enrollment_effective_date"
    t.date "association_start_date"
    t.date "business_end_date"
  ...
  create_table "npi_webcrawler_logs", force: :cascade do |t|
    t.string "npi_number"
    t.string "filepath"
    t.string "filetype"
    t.string "status"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["provider_personal_information_id"], name: "index_npi_webcrawler_logs_on_provider_personal_information_id"
  end
  ...
  create_table "provider_enrollment_groups", force: :cascade do |t|
    t.bigint "provider_id", null: false
    t.integer "group_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["provider_id"], name: "index_provider_enrollment_groups_on_provider_id"
  end
  ...
  create_table "provider_insurance_coverages", force: :cascade do |t|
    ...
    t.string "form_type"
    t.boolean "prof_liability_does_not_expire"
  ...
  create_table "provider_personal_informations", force: :cascade do |t|
    ...
    t.date "latest_audit_completed_date"
    t.string "specialty_name_1"
    t.string "specialty_name_2"
    t.string "specialty_name_3"
    t.string "specialty_name_4"
    t.string "specialty_name_5"
  ...
  create_table "rva_informations", force: :cascade do |t|
    ...
    t.bigint "provider_personal_information_peer_ref_id"
    t.bigint "provider_personal_information_facility_id"
    t.bigint "provider_cd_id"
    ...
    t.index ["provider_cd_id"], name: "index_rva_informations_on_provider_cd_id"
    ...
    t.index ["provider_personal_information_facility_id"], name: "idx_rva_info_facilities"
    t.index ["provider_personal_information_id"], name: "index_rva_informations_on_provider_personal_information_id"
    t.index ["provider_personal_information_peer_ref_id"], name: "idx_rva_info_peer_ref"
  ...
  create_table "state_license_url_histories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["state_id"], name: "index_state_license_url_histories_on_state_id"
  end
  ...
  add_foreign_key "npi_webcrawler_logs", "provider_personal_informations"
  ...
  add_foreign_key "pdf_generation_queues", "users"
  ...
  add_foreign_key "provider_enrollment_groups", "providers"
  ...
  add_foreign_key "rva_informations", "provider_cds"
  ...
  add_foreign_key "rva_informations", "provider_personal_information_facilities"
  add_foreign_key "rva_informations", "provider_personal_information_peer_refs"
  ...
  add_foreign_key "state_license_url_histories", "states"
