class CreatePracticeOtherQuestions < ActiveRecord::Migration[7.0]
  def self.up
    create_table :practice_other_questions, id: false do |t|
      t.primary_key   :provider_practice_other_id
    ...
    add_column :practice_other_questions, :provider_practice_id, :integer
